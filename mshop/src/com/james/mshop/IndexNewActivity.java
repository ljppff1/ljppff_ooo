...
import com.james.mshop.IndexNewActivity;
	...
	public  void btn_search(View v) {
		         ...
		         if ("".equals(mString_Research)||mString_Research==null) {
					showDialog(1);
		        	 ...
		        	 Intent intent = new Intent(IndexNewActivity.this,SearchResultActivity.class);
	...
	private void selectItem() {
    	mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					int position, long id) {
				Intent intent = new Intent(IndexNewActivity.this,Tab1Activity.class);
