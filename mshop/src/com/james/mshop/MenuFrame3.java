...
import com.james.mshop.MenuFrame2.MyAdapter;
import com.james.mshop.MenuFrame2.ProductAsyTask;
import com.james.mshop.MenuFrame2.ProductColorTask;
import com.james.mshop.MenuFrame2.ProductSizeTask;
...
public class MenuFrame3 extends Fragment 
{  
			...
			Bundle savedInstanceState)
	{
		...
		View layout = inflater.inflate(R.layout.activity_pro__detail, null);
...
protected void onPostExecute(String result) {
	...
	try {
		...
		String string_Detail1 = data.getString("detail2");
