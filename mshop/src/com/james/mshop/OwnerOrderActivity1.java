...
public class OwnerOrderActivity1 extends Base3Activity {
...
private void initAdapter() {
	 ...
	 View layout = getLayoutInflater().inflate(R.layout.item_listview_ownorder_lastitem, null);
	   ...
	   btn_Payfor.setVisibility(View.GONE);
	   ...
	   btn_Payfor.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent=new Intent(OwnerOrderActivity1.this,PayPalActivity.class);
...
class AsyTask extends AsyncTask<String, Void, String>{  
	...
	protected void onPostExecute(String result) {
		...
		try {
	    	...
	    	Toast.makeText(OwnerOrderActivity1.this, "訂單已取消", Toast.LENGTH_SHORT).show();
	    	startActivity(new Intent(OwnerOrderActivity1.this,CaseManagerActivity.class));
		} catch (JSONException e) {
			e.printStackTrace();
		}
	}
