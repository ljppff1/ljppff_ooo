...
public class CaseDetailActivity extends Base3Activity {
		...
		View layout = getLayoutInflater().inflate(R.layout.item_listview_ownorder_lastitem, null);
		   ...
		   btn_Cancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//取消訂單
				new AsyTask().execute("http://josie.i3.com.hk/mshop/json/m_ordercancel.php?mid=1" +
						"&id="+mString_Id);
				downLoad();
			}
		   });
		   btn_Payfor.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					Intent intent=new Intent(CaseDetailActivity.this,PayPalActivity.class);
	 ...
	 class Myadapter extends BaseAdapter{
		   @Override
			public View getView(int position, View convertView, ViewGroup parent) {
			   ...
			   ImageView imageView=(ImageView) layout.findViewById(R.id.iv_listview_ownorder_image);
		   ...
		   tv_Size.setText(mSizeList.get(position));
			   Log.e("OwnerOrd44444er", mImageUrlList.get(position));
			   Log.e("position", ""+position);
			   Log.e("OwnerOrder444444", mColorList.get(position));
				return layout;
			}
		@Override
		public int getCount() {
	...
	class AsyTask extends AsyncTask<String, Void, String>{  
		...
		protected void onPostExecute(String result) {
			...
			try {
		    	...
		    	Toast.makeText(CaseDetailActivity.this, "訂單已取消", Toast.LENGTH_SHORT).show();
		    	startActivity(new Intent(CaseDetailActivity.this,CaseManagerActivity.class));
			} catch (JSONException e) {
				e.printStackTrace();
			}
		}
