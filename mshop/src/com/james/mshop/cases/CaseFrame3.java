...
public class CaseFrame3 extends Fragment 
{  
...
private View mLayout;
	...
	{
		mLayout = inflater.inflate(R.layout.activity_case3, null);
		//獲得member_id
	  ...
	  //UIL
		...
		class Myadapter extends BaseAdapter{
			...
			public View getView(final int position, View convertView, ViewGroup parent) {
				View layout = getActivity().getLayoutInflater().inflate(R.layout.item_listview_case3, null);
				...
				Button  btn_Payfor = (Button) layout.findViewById(R.id.btn_listview_case3_makesure_address);
				 ...
				 initImageLoaderOptions();
					...
					btn_Payfor.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							//确认收货
						new AsyTask().execute("http://josie.i3.com.hk/mshop/json/m_orderconfirm.php?mid=" +mEmber_ID+
				...
				try {
					...
					if ("1".equals(code)) {
						...
						mTotalRmbList.add(string_TotalRmb);
						  ...
						  //初始化適配器
						  mLayout.findViewById(R.id.listView_case3).setVisibility(View.VISIBLE);
						  mListView = (ListView) mLayout.findViewById(R.id.listView_case3);
						//ListView 點擊
						selectItem();
						initAdapter();
						mLayout.findViewById(R.id.mPbcaseframe3).setVisibility(View.GONE);
					}
					else {
						mLayout.findViewById(R.id.rela_nocse3).setVisibility(View.VISIBLE);
						mLayout.findViewById(R.id.mPbcaseframe3).setVisibility(View.GONE);
					...
					try {
						...
						if(!TextUtils.isEmpty(code)){
							if(code.equals("1")){
								...
								mTotalRmbList.clear();
								downLoad();
								Toast.makeText(getActivity(), "確認收貨成功", Toast.LENGTH_SHORT).show();

							}else{
								Toast.makeText(getActivity(), "確認收貨失敗", Toast.LENGTH_SHORT).show();
							}
						}else{
							Toast.makeText(getActivity(), "確認收貨失敗", Toast.LENGTH_SHORT).show();
						}
