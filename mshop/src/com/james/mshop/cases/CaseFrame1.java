...
public class CaseFrame1 extends Fragment 
{  
...
private ArrayList<String>    mNoList=new ArrayList<String>();
...
private View mLayout;
	...
	{
		mLayout = inflater.inflate(R.layout.activity_case1, null);
		//獲得member_id
	 ...
	 private void selectItem() {
	    	mListView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
						long arg3) {
	                Intent intent=new Intent(getActivity(),OwnerOrderActivity.class);
	  ...
	  //UIL
		...
		class Myadapter extends BaseAdapter{
			...
			public View getView(final int position, View convertView, ViewGroup parent) {
				View layout = getActivity().getLayoutInflater().inflate(R.layout.item_listview_case1, null);
				...
				tv_Total.setText("HK$ "+mTotalHKList.get(position)+"  ￥"+mTotalRmbList.get(position));
				 initImageLoaderOptions();
					...
					btn_Payfor.setOnClickListener(new OnClickListener() {
						...
						@Override
						public void onClick(View v) {
/*							Intent intent=new Intent(getActivity(),ChoiceadressActivity.class);
							 Bean.setAccount("HK$ "+mHKList.get(position)+"  ￥"+mRmbList.get(position));

							startActivity(intent);
*/											Intent intent=new Intent(getActivity(),PayPalActivity.class);
                                             intent.putExtra("NAME", mNameList.get(position));
                                             intent.putExtra("HK", mHKList.get(position));
                                             intent.putExtra("ID", mNoList.get(position));
                                         startActivity(intent);
			...
			protected void onPostExecute(String result) {
				...
				try {
					...
					if ("1".equals(code)) {
						...
						String	 string_no= jsonObject2.getString("no");
						...
						mTotalRmbList.add(string_TotalRmb);
						  ...
						  //初始化適配器
						  mLayout.findViewById(R.id.listView_case1).setVisibility(View.VISIBLE);
						  mListView = (ListView) mLayout.findViewById(R.id.listView_case1);
						//ListView 點擊
						selectItem();
						initAdapter();
						mLayout.findViewById(R.id.mPbcaseframe1).setVisibility(View.GONE);
					}
					else {
						mLayout.findViewById(R.id.rela_nocse).setVisibility(View.VISIBLE);
						mLayout.findViewById(R.id.mPbcaseframe1).setVisibility(View.GONE);
					}
